...
export const Modal = () => {
    ...
    const [isOpen, closeModal, newTaskInput, setNewTaskInput, image, setImage, newTaskType] = useModalStore((state) => [
        state.isOpen,
        state.closeModal,
        state.newTaskInput,
        state.setNewTastInput,
        state.image,
        state.setImage,
        state.newTaskType
    ])

    const [addTask] = useBoardStore((state) => [
        state.addTask
    ])
